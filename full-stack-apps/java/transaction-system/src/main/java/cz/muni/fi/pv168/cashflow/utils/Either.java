...
public abstract class Either<L, R> {
     ...
     *
     * @param value The value to be placed into
     */
     ...
     *
     * @param lFunc A function to be applied if the  contains the left value.
     * @param rFunc A function to be applied if the  contains the right value.
     */
     ...
     *
     * @param lFunc A consumer to be applied if the  contains the left value.
     * @param rFunc A consumer to be applied if the  contains the right value.
     */
